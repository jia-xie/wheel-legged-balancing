...
void Leg_TorqCtrl(float lf, float rf, float rr, float lr);
...
void Leg_VMC(Leg_t *leg, float force, float torq)
{
    ...
    float xC_minus_xB = (-leg_length * sin_theta) - (
        -HALF_THIGH_DISTANCE + THIGH_LENGTH * cos_phi1);
    float yC_minus_yB = (leg_length * cos_theta) - THIGH_LENGTH * sin_phi1;
    float xC_minus_xD = (-leg_length * sin_theta) - (
        HALF_THIGH_DISTANCE + THIGH_LENGTH * cos_phi4);;
    float yC_minus_yD = (leg_length * cos_theta) - THIGH_LENGTH * sin_phi4;
    
    float M11 = ((-sin_theta*xC_minus_xB+cos_theta*yC_minus_yB)/
                                  (-sin_phi1*xC_minus_xB+cos_phi1*yC_minus_yB))/THIGH_LENGTH;
    ...
    float M21 = ((-sin_theta*xC_minus_xD+cos_theta*yC_minus_yD)/
                                  (-sin_phi4*xC_minus_xD+cos_phi4*yC_minus_yD))/THIGH_LENGTH;
