...
void IT_DecodeCAN1()
{
  ...
  {
  case 0x04:
    DM4310_DecodeCAN(data_temp, &leg_motors[0]);
    break;
  case 0x05:
    DM4310_DecodeCAN(data_temp, &leg_motors[1]);
    break;
  case 0x02:
    DM4310_DecodeCAN(data_temp, &leg_motors[2]);
    break;
  case 0x07:
    DM4310_DecodeCAN(data_temp, &leg_motors[3]);
    break;
